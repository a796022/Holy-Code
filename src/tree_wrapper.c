 ...
 * @return int
*/
static void load_tree(struct WindowStructure* window_structure, const char *filename, GtkWidget* tree_view) {
    // "Get the model"
    ...
    // Load the tree from the file
    read_tree_file(window_structure, filename, tree_view);
}
